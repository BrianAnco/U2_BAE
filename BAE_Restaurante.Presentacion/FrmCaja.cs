        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        CajaNegocios i = new CajaNegocios();
                        Rpta = i.Insertar(dteFecha.Value, Convert.ToDouble(txtReserva.Text), Convert.ToDouble(txtIngreso.Text), Convert.ToDouble(txtEgreso.Text), txtComentario.Text);
                        if (Rpta.Equals("OK"))
                        {
