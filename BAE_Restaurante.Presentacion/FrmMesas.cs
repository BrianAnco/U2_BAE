            ...
            try
            {
                ...
                for (int i = 0; i < dgvMesas.RowCount; i++)
                {
                    if (i >= 10)
                    {
                        ...
                        {
                            dgvFotos2.Rows.Add(Image.FromFile("D:/Laboratorios Programación II/MesasBAE/Verde.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                        else
                        {
                            dgvFotos2.Rows.Add(Image.FromFile("D:/Laboratorios Programación II/MesasBAE/Rojo.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                    }
                    else
                    {
                        if (Convert.ToBoolean(dgvMesas.Rows[i].Cells[2].Value) == false)
                        {
                            dgvFotos.Rows.Add(Image.FromFile("D:/MesasBAE/Verde.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                        else
                        {
                            dgvFotos.Rows.Add(Image.FromFile("D:/MesasBAE/Rojo.png"), Convert.ToString(dgvMesas.Rows[i].Cells[1].Value));
                        }
                    }
