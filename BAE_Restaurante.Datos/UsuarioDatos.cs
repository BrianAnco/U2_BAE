...
namespace BAE_Restaurante.Datos
{
    public class UsuarioDatos
    {
        ...
        public bool Login(string usuario, string contrasena)
        {
            ...
            {
                sqlCnx = Conexion.getInstancia().EstablecerConexion();
                SqlCommand comando = new SqlCommand("Select usuario, contrasena from Usuario where usuario = @usuario and contrasena = @contrasena", sqlCnx);
        ...
        public void log_login(string usuario)
        {
            SqlDataReader resultado;
            SqlConnection sqlCnx = new SqlConnection();
            try
            {
                sqlCnx = Conexion.getInstancia().EstablecerConexion();
                SqlCommand comando = new SqlCommand("insert into Login_ values(@usuario)", sqlCnx);
                comando.Parameters.AddWithValue("@usuario", usuario);
